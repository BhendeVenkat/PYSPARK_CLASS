...
def process():
    ...
    very_large_dataset_location = 'E:\ADF_VIDEOS\SOURCE_FILES\customer2.csv'
    very_large_dataframe = spark.read.csv(very_large_dataset_location, header=True, sep=",")
    print(len(very_large_dataframe.columns))
    #very_large_dataframe.show()
    very_large_dataframe.limit(3).show()
    ...
    small_product_dimension_dataset = 'E:\ADF_VIDEOS\SOURCE_FILES\EMPLOYEES.parquet'  # 50 MB of parquet
